...
class Downstream_Dataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        log_li = data_row.iloc[3]
        comonomer_percentage = data_row.iloc[4]/100
        approxMW = data_row.iloc[5]
        approxTg = data_row.iloc[6]
        chain_architecture = data_row.iloc[7]
        new_feats = data_row.iloc[8:-1].astype(float).values
